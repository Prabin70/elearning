          ...
          <div className="grid grid-cols-2 gap-2 sm:grid sm:gap-6 px-3 mt-8 sm:px-0 lg:mt-16 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-12">
            <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
              <div className="sm:px-4 sm:py-6">
                <div className="flex flex-col items-center">
                  <svg
                    className="flex-shrink-0 h-10 w-10 sm:w-12 sm:h-12 text-green-600"
            ...
            <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
              <div className="sm:px-4 sm:py-6">
                <div className="flex flex-col items-center">
                  <svg
                    className="flex-shrink-0 h-7 w-7 sm:w-12 sm:h-12 text-gray-900"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="red"
            ...
            <div className="overflow-hidden bg-white border border-gray-200 rounded-lg">
              <div className="sm:px-4 sm:py-6">
                <div className="flex flex-col items-center">
                  <svg
                    className="flex-shrink-0 w-7 h-7 sm:w-12 sm:h-12 text-blue-600"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  ...
                  <div className="ml-4 gap-1 flex">
                    ...
                    <p className="mt-1.5  text-sm sm:text-lg font-medium leading-tight text-gray-500">
                      Customer success
                    </p>
                  </div>
                </div>
