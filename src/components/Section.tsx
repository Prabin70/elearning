    ...
    <div>
      <section className="py-10 bg-white sm:py-16 lg:py-24">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <h2 className="flex md:items-center justify-center text-[30px]  md:text-[45px] font-bold mb-5">
            What we offers to our users...!
          </h2>
          <div className="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16">
            <div>
              ...
              <p className="mt-4 text-base text-gray-600">
                We are committed to providing a secure and reliable payment
                experience for all our customers. When you shop with us, your
                payment details are protected at every step.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-base text-gray-600">
                We ensure all transactions are secure and encrypted. Pay
                confidently using trusted methods like PayPal, Stripe, or
                credit/debit cards
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-base text-gray-600">
                Modern designs often include a theme toggle allowing users to
                switch between light and dark modes for personalized
                experiences.t.
              </p>
            </div>
